...
export const COURSES: Course[] = [
  ...
  },
  {
    ...
    description:
      "Claude Code가 레퍼런스 채널을 분석해 대본과 비주얼 프롬프트를 뽑고, Google Flow로 클립을 만들고, Typecast(한국어 최적) 또는 ElevenLabs로 더빙하고, ffmpeg로 9:16 쇼츠를 조립합니다. 건축 지식 쇼츠를 예시로 진행하며, 마지막엔 전체 파이프라인을 스킬 하나로 저장해 원클릭 실행합니다.",
    level: "입문+",
